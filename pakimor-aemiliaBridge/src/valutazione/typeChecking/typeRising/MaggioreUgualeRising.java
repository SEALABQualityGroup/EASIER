...
class MaggioreUgualeRising {
    ...
    public MaggioreUgualeRising(int depth)
    	{
    	super();
	...
	public DataTypeEnum risingMaggioreUguale(MaggioreUguale maggioreUguale, String parent, 
    		DataType dataType)
		...
		try {
			...
			if (typeRising.isErrorOccurred())
				{
				String string = "type checking error for " + maggioreUguale.toString();
