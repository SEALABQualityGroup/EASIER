 ...
 *
 */
public class CheckFromSelector {
	...
	public CheckFromSelector(AttacDecl attacDecl,
	...
	/**
	 * Il selettore from deve essere valutato come un intero.
	 * 
	 * @return
	 * @throws TypeCheckingException
	 */
	public boolean checkFromSelector()
		throws TypeCheckingException
		{
		try {
			AEIident aeIident = this.attacDecl.getOutputAei();
