 ...
 *
 */
public class CheckRange6 {

	private AttacDeclInd attacDeclInd;
	private int depth;
	private ErrorMessage errorMessage;
	
	public CheckRange6(AttacDeclInd attacDeclInd, int depth) {
		super();
	...
	/**
	 * Il valore dell'espressione iniziale del secondo range  
	 * non puo' essere piu' grande del valore dell'espressione
	 * finale del secondo range. Per precondizione le espressioni iniziale e finale sono in forma normale.
	 * 
	 * @return
	 */
	public boolean checkRange6()
		throws TypeCheckingException
		{
		try {
			Expression expression = this.attacDeclInd.getBeginningExpr2();
			if (expression != null) {
				// per precondizione expressione'un intero
				Integer integer = (Integer) expression;
				Expression expression3 = this.attacDeclInd.getEndingExpr2();
