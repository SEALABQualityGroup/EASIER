...
class NormalizeMinoreUguale {
	...
	public BooleanNorm normalizeMinoreUguale(MinoreUguale minoreUguale, String parent, DataType dataType)
		...
		if (!normalizeExpressionStrict.isErrorOccurred()) 
			...
			if (!normalizeExpressionStrict2.isErrorOccurred()) 
				...
				if ((expression5 instanceof NumberExp)
					...
					if (!(expression5 instanceof NumberExp))
						{
						String string = "Normalizing error for " + minoreUguale.toString();
