 ...
 *
 */
class ScanMaggioreUguale {

	private int depth;
	private ErrorMessage errorMessage;
	
	public ScanMaggioreUguale(int depth) 
		{
		super();
		this.depth = depth;
	 ...
	 */
	public boolean isMaggioreUguale(String specifiche)
		{
		/* MODELLED */
		...
		while (s.hasNext())
			...
			try {
				...
				{
				String string = specifiche + " is not greater than or equal expression";
	 ...
	 */
	public MaggioreUguale scanMaggioreUguale(String specifiche)
		throws ScanException
		{
		try {
			// Ea >= Ea
