...
class ScanMaggiore {
	 ...
	 */
	public boolean isMaggiore(String specifiche)
		{
		/* MODELLED */
		...
		while (s.hasNext())
			...
			if (!s.hasNext("\\s*\\>(.)*")) 
				{
				String string = specifiche + " is not greater than expression";
	 ...
	 */
	public Maggiore scanMaggiore(String specifiche)
		throws ScanException
		{
		try {
			// Ea > Ea
