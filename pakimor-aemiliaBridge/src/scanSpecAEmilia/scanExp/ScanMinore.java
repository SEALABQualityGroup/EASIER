...
class ScanMinore {
	 ...
	 */
	public boolean isMinore(String specifiche)
		{
		/* MODELLED */
		...
		while (s.hasNext())
			...
			try {
				...
				{
				String string = specifiche + " is not less than expression";
	 ...
	 */
	public Minore scanMinore(String specifiche)
		throws ScanException
		{
		try {
			// Ea < Ea
