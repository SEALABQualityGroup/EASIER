...
import it.disim.univaq.sealab.ttep.rew.wizard.normalize.checking.CheckInteger;
...
public class NormalizeRewardAssignInd 
	...
	public List<RewardAssign> normalizeRewardAssignInd(
		...
		it.disim.univaq.sealab.ttep.rew.wizard.normalize.checking.CheckRange checkRange = new it.disim.univaq.sealab.ttep.rew.wizard.normalize.checking.CheckRange(expression2,expression4,this.depth + 1);
		try {
