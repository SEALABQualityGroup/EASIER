...
import it.disim.univaq.sealab.ttep.rew.classes.RewardType;
...
public class NormalizeRewardAssign {
	...
	public RewardAssignNorm normalizeRewardAssign(
		...
		try {
			...
			it.disim.univaq.sealab.ttep.rew.wizard.normalize.checking.CheckSelectorRA checkSelectorRA = new it.disim.univaq.sealab.ttep.rew.wizard.normalize.checking.CheckSelectorRA(rewardAssign, treeMap, this.depth + 1);
