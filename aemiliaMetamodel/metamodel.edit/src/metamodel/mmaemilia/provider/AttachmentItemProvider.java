...
/**
 * This is the item provider adapter for a {@link metamodel.mmaemilia.Attachment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AttachmentItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(mmaemiliaPackage.Literals.ATTACHMENT__END);
			childrenFeatures.add(mmaemiliaPackage.Literals.ATTACHMENT__START);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(mmaemiliaPackage.Literals.ATTACHMENT__END,
				 mmaemiliaFactory.eINSTANCE.createTo()));

		newChildDescriptors.add
			(createChildParameter
				(mmaemiliaPackage.Literals.ATTACHMENT__START,
				 mmaemiliaFactory.eINSTANCE.createFrom()));
	}
