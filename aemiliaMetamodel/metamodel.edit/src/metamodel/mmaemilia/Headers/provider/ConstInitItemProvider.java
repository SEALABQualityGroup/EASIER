...
/**
 * This is the item provider adapter for a {@link metamodel.mmaemilia.Headers.ConstInit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConstInitItemProvider
	 ...
	 * @generated
	 */
	public ConstInitItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ConstInit_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ConstInit_name_feature", "_UI_ConstInit_type"),
				 HeadersPackage.Literals.CONST_INIT__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(HeadersPackage.Literals.CONST_INIT__INIT_CONST_DATA);
			childrenFeatures.add(HeadersPackage.Literals.CONST_INIT__INIT_CONST_EXPR);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ConstInit"));
	}
	...
	public String getText(Object object) {
		String label = ((ConstInit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ConstInit_type") :
			getString("_UI_ConstInit_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ConstInit.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(HeadersPackage.Literals.CONST_INIT__INIT_CONST_DATA,
		...
		newChildDescriptors.add
			(createChildParameter
				(HeadersPackage.Literals.CONST_INIT__INIT_CONST_DATA,
				 DataTypeFactory.eINSTANCE.createSpecial()));
		...
		newChildDescriptors.add
			(createChildParameter
				(HeadersPackage.Literals.CONST_INIT__INIT_CONST_EXPR,
