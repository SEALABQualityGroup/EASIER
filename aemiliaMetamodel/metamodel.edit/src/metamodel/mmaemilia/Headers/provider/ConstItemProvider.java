...
/**
 * This is the item provider adapter for a {@link metamodel.mmaemilia.Headers.Const} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConstItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Const_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Const_name_feature", "_UI_Const_type"),
				 HeadersPackage.Literals.CONST__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(HeadersPackage.Literals.CONST__CONSTANT_DATA);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(HeadersPackage.Literals.CONST__CONSTANT_DATA,
