...
/**
 * This is the item provider adapter for a {@link metamodel.mmaemilia.Behavior.ActionOutput} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActionOutputItemProvider
	extends ActionTypeItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BehaviorPackage.Literals.ACTION_OUTPUT__EXPR_OUTPUT);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ActionOutput"));
	}
	...
	public String getText(Object object) {
		return getString("_UI_ActionOutput_type");
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ActionOutput.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(BehaviorPackage.Literals.ACTION_OUTPUT__EXPR_OUTPUT,
