...
/**
 * This is the item provider adapter for a {@link metamodel.mmaemilia.Expressions.ListExpr} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ListExprItemProvider
	 ...
	 * @generated
	 */
	public ListExprItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ListExpr_operation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ListExpr_operation_feature", "_UI_ListExpr_type"),
				 ExpressionsPackage.Literals.LIST_EXPR__OPERATION,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ExpressionsPackage.Literals.LIST_EXPR__LIST_OPERANDS);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ListExpr"));
	}
	...
	public String getText(Object object) {
		ListOpName labelValue = ((ListExpr)object).getOperation();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_ListExpr_type") :
			getString("_UI_ListExpr_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ListExpr.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ExpressionsPackage.Literals.LIST_EXPR__LIST_OPERANDS,
