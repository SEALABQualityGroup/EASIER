 ...
 * </p>
 * <ul>
 *   <li>{@link logicalSpecification.impl.OrOperatorImpl#getArguments <em>Arguments</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OrOperatorImpl extends LogicalOperatorImpl implements OrOperator {
	...
	protected EClass eStaticClass() {
		return LogicalSpecificationPackage.Literals.OR_OPERATOR;
	}
	...
	public EList<Operator> getArguments() {
		if (arguments == null) {
			arguments = new EObjectContainmentWithInverseEList<Operator>(Operator.class, this, LogicalSpecificationPackage.OR_OPERATOR__ARGUMENTS, LogicalSpecificationPackage.OPERATOR__OR_OPERATOR);
		}
		return arguments;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case LogicalSpecificationPackage.OR_OPERATOR__ARGUMENTS:
