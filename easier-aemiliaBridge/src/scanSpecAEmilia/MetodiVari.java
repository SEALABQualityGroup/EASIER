...
public class MetodiVari 
	...
	// restituisce il termine di processo processTerm concatenato in modo non deterministico con
	// processTerm2. processTerm puo' avere foglie uguali a null. Se a processTerm non puo'
	// essere concatenato processTerm2 si restituisce null.
	// 
	public static ProcessTerm somma(ProcessTerm processTerm,
			ProcessTerm processTerm2)
		{
		...
		if (processTerm instanceof ActionProcess)
			...
			if (processTerm3 == null)
				{
				((ActionProcess)term).setProcesso(
						processTerm2 == null ? null : processTerm2.copy());
				}
			else
				{
				ProcessTerm processTerm4 = somma(
	...
	public static ActionProcess somma(Action action,
			ProcessTerm processTerm2)
		{
	...
	public static List<ProcessTerm> differenza(ProcessTerm processTerm,
			ProcessTerm processTerm2)
		{
	...
	public static boolean isOnlyInteger(Expression expression)
		...
		if (!(expression instanceof specificheAEmilia.Integer))
			return false;
		return true;
		}
	...
	/*
	 * Restituisce la chiamata di comportamento di processTerm.
	 * Restituisce null se processTerm non ha un BehavProcess come comportamento finale, 
	 * Se processTerme'uno ChoiceProcess si restituisce la coda del primo processo.
	 */
