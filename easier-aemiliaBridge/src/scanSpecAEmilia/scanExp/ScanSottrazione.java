 ...
 *
 */
class ScanSottrazione {

	private int depth;
	private ErrorMessage errorMessage;
	
	public ScanSottrazione(int depth) 
		{
		super();
		this.depth = depth;
	 ...
	 */
	public boolean isSottrazione(String specifiche)
		{
		/* MODELLED */
		...
		while (s.hasNext())
			...
			try {
				...
				{
				String string = specifiche + " is not subtraction expression";
	 ...
	 */
	public Sottrazione scanSottrazione(String specifiche)
		throws ScanException
		{
		try {
			// Ea - Eat
