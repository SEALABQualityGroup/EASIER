...
class DifferentRising {
    ...
    public DifferentRising(int depth)
    	{
    	super();
	...
	public DataTypeEnum risingDifferent(Different different, String parent, 
    		DataType dataType)
		...
		try {
			...
			if (typeRising.isErrorOccurred())
				{
				String string = "type checking error for " + different.toString();
