...
class ReadRising {
	...
	public DataTypeEnum risingRead(Read read, String parent, 
    		DataType dataType)
		...
		try {
			...
			if (typeRising.isErrorOccurred())
				{
				String string = "type checking error for " + read.toString();
			...
			// per precondizione dataType2e'ArrayType
