...
class DivisioneRising {
    ...
    public DivisioneRising(int depth)
    	{
    	super();
	...
	public DataTypeEnum risingDivisione(Divisione divisione, String parent, 
    		DataType dataType)
		...
		try {
			...
			if (!typeRising.isErrorOccurred())
				{	
				String string = "type checking error for " + divisione.toString();
