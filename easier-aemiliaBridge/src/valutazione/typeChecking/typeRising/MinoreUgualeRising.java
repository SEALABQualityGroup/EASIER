...
class MinoreUgualeRising {
    ...
    public MinoreUgualeRising(int depth)
    	{
    	super();
	...
	public DataTypeEnum risingMinoreUguale(MinoreUguale minoreUguale, String parent, 
    		DataType dataType)
		...
		try {
			...
			if (typeRising.isErrorOccurred())
				{
				String string = "type checking error for " + minoreUguale.toString();
