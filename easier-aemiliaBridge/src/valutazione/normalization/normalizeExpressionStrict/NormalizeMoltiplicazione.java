...
class NormalizeMoltiplicazione {
	...
	public NumberExpNorm normalizeMoltiplicazione(Moltiplicazione moltiplicazione, String parent,
			DataType dataType)
				...
				if (!normalizeExpressionStrict2.isErrorOccurred()) 
					...
					if ((expression5 instanceof NumberExp)
						...
						if (f == g) 
							...
							integerNorm.setOldExpression(moltiplicazione);
    ...
    public NumberExpNorm normalizeMoltiplicazione(Moltiplicazione moltiplicazione, String parent, DataType dataType, 
