...
/**
 * Rappresenta un'operazione di somma di una
...
public class Somma extends Expression {
	...
	/**
	 * Crea un oggetto Somma con operandi forniti come
	 * parametri.
	 ...
	 */
	public Somma(Expression expr1, Expression expr2) {
		this.Expr1 = expr1;
		this.Expr2 = expr2;
	}
	...
	public void print()
		{
		System.out.println("Somma object");
		super.print();
	 ...
	 * @param s - oggetto Somma da confrontare.
	...
	public boolean equals(Object o)
		{
		if (!(o instanceof Somma)) return false;
		Somma s = (Somma)o;
