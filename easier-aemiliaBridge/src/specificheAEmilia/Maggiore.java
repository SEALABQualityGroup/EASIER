...
/**
 * Rappresenta un'operatore booleano di maggiore. In AEmilia ha
 ...
 * @version 1.0
 */
public class Maggiore extends Expression 
	{
	...
	/**
	 * Crea un oggetto Maggiore vuoto.
	 *
	 */
	public Maggiore() {
		}
	...
	/**
	 * Crea un oggetto Maggiore con gli operandi forniti
	 * come parametri.
	 * @param Expr1 - oggetto Expression.
	 * @param Expr2 - oggetto Expression.
	 */
	public Maggiore(Expression Expr1, Expression Expr2) {
		this.Expr1 = Expr1;
		this.Expr2 = Expr2;
		}
	...
	public void print()
		{
		System.out.println("Maggiore object");
		super.print();
	...
	public boolean equals(Object o)
		{
		if (!(o instanceof Maggiore)) return false;
		Maggiore m = (Maggiore)o;
