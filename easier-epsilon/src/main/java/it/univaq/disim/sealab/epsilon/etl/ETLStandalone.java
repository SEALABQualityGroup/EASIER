...
public class ETLStandalone extends EpsilonStandalone {
	...
	final static String lqnMetamodel = "/home/peo/git/sealab/uml2lqn/org.univaq.uml2lqn/lqnxsd/lqn.xsd.ecore";
...
//			model.add(createXMLModel("LQN", modelFilePath.getParent().resolve("output.xml")));
	...
	public EpsilonStandalone setModel(IModel m) {
		model.add(m);
		model.add(createOutputEmfModel("LQN", outputFolder.resolve("output.xml"), lqnMetamodel));
		return this;
	}
