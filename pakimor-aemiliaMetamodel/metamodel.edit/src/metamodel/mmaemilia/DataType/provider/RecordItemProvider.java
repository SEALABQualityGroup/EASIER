...
/**
 * This is the item provider adapter for a {@link metamodel.mmaemilia.DataType.Record} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RecordItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addField_decl_seqPropertyDescriptor(object);
		}
		return itemPropertyDescriptors;
	}

	/**
	 * This adds a property descriptor for the Field decl seq feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addField_decl_seqPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Record_field_decl_seq_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Record_field_decl_seq_feature", "_UI_Record_type"),
				 DataTypePackage.Literals.RECORD__FIELD_DECL_SEQ,
				 true,
				 false,
				 false,
				 null,
