...
/**
 * This is the item provider adapter for a {@link metamodel.mmaemilia.Behavior.RatePas} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RatePasItemProvider
	 ...
	 * @generated
	 */
	public RatePasItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BehaviorPackage.Literals.RATE_PAS__PRIORITY);
			childrenFeatures.add(BehaviorPackage.Literals.RATE_PAS__WEIGHT);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/RatePas"));
	}
	...
	public String getText(Object object) {
		return getString("_UI_RatePas_type");
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(RatePas.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(BehaviorPackage.Literals.RATE_PAS__PRIORITY,
		...
		newChildDescriptors.add
			(createChildParameter
				(BehaviorPackage.Literals.RATE_PAS__WEIGHT,
				 ExpressionsFactory.eINSTANCE.createExpression()));
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == BehaviorPackage.Literals.RATE_PAS__PRIORITY ||
			childFeature == BehaviorPackage.Literals.RATE_PAS__WEIGHT;
