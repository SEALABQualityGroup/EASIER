...
/**
 * This is the item provider adapter for a {@link metamodel.mmaemilia.Behavior.RateExp} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RateExpItemProvider
	 ...
	 * @generated
	 */
	public RateExpItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BehaviorPackage.Literals.RATE_EXP__EXPR);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/RateExp"));
	}
	...
	public String getText(Object object) {
		return getString("_UI_RateExp_type");
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(RateExp.class)) {
			case BehaviorPackage.RATE_EXP__EXPR:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(BehaviorPackage.Literals.RATE_EXP__EXPR,
