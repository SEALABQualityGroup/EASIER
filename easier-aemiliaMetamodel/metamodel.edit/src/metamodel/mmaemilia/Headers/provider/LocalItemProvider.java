...
/**
 * This is the item provider adapter for a {@link metamodel.mmaemilia.Headers.Local} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LocalItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Local_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Local_name_feature", "_UI_Local_type"),
				 HeadersPackage.Literals.LOCAL__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(HeadersPackage.Literals.LOCAL__LOCAL_TYPE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(HeadersPackage.Literals.LOCAL__LOCAL_TYPE,
