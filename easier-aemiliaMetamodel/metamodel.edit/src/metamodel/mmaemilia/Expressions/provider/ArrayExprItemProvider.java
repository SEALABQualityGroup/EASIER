...
/**
 * This is the item provider adapter for a {@link metamodel.mmaemilia.Expressions.ArrayExpr} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArrayExprItemProvider
	 ...
	 * @generated
	 */
	public ArrayExprItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ArrayExpr_operation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ArrayExpr_operation_feature", "_UI_ArrayExpr_type"),
				 ExpressionsPackage.Literals.ARRAY_EXPR__OPERATION,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ExpressionsPackage.Literals.ARRAY_EXPR__ARRAY_OPERANDS);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ArrayExpr"));
	}
	...
	public String getText(Object object) {
		ArrayOpName labelValue = ((ArrayExpr)object).getOperation();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_ArrayExpr_type") :
			getString("_UI_ArrayExpr_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ArrayExpr.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ExpressionsPackage.Literals.ARRAY_EXPR__ARRAY_OPERANDS,
