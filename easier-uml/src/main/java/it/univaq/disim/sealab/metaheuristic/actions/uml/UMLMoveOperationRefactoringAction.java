...
public class UMLMoveOperationRefactoringAction extends UMLMoveOperationActionImpl implements RefactoringAction {
...
//		}
	...
	public void setParameters() {
		...
		setOpToMoveSVP(Manager.getInstance(UMLManager.getInstance()).createSingleValueParameter(
				((UMLOclStringManager) OclStringManager.getInstance(new UMLOclStringManager()))
