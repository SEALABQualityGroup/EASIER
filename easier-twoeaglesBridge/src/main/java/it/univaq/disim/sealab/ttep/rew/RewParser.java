 ...
 */
  ...
  final public it.univaq.disim.sealab.ttep.rew.classes.RewardType RewardType() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case T_STATE_REWARD:
      jj_consume_token(T_STATE_REWARD);
                {if (true) return it.univaq.disim.sealab.ttep.rew.classes.RewardType.STATE_REWARD;}
      break;
    case T_TRANS_REWARD:
      jj_consume_token(T_TRANS_REWARD);
                {if (true) return it.univaq.disim.sealab.ttep.rew.classes.RewardType.TRANS_REWARD;}
      break;
    default:
      jj_la1[11] = jj_gen;
      jj_consume_token(-1);
  ...
  final public it.univaq.disim.sealab.ttep.rew.classes.RewardAssign RewardAssign() throws ParseException {
        Token t1;
        Token t2;
        Token t3;
  ...
  final public it.univaq.disim.sealab.ttep.rew.classes.RewardStructure RewardStructure() throws ParseException {
  ...
  final public it.univaq.disim.sealab.ttep.rew.classes.MeasureDef MeasureDef() throws ParseException {
        Token t1;
        Token t2;
        specificheAEmilia.Expression e1 = null;
        specificheAEmilia.Expression e2;
  ...
  final public it.univaq.disim.sealab.ttep.rew.classes.RewSpec RewSpec() throws ParseException {
