...
import it.univaq.disim.sealab.ttep.rew.wizard.normalize.structure.RewardStructureNorm;
...
public class NormalizeMeasureDef 
	...
	public MeasureDefNorm normalizeMeasureDef(MeasureDef measureDef,
		...
		try {
			...
			it.univaq.disim.sealab.ttep.rew.wizard.normalize.checking.CheckSelector checkSelector = new it.univaq.disim.sealab.ttep.rew.wizard.normalize.checking.CheckSelector(measureDef, treeMap, this.depth + 1);
