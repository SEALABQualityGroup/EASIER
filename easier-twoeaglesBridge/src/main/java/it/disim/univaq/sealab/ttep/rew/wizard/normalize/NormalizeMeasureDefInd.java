...
public class NormalizeMeasureDefInd {
	...
	public List<MeasureDef> normalizeMeasureDefInd(MeasureDefInd measureDefInd) throws NormalizeException {
		...
		it.disim.univaq.sealab.ttep.rew.wizard.normalize.checking.CheckRange checkRange = new it.disim.univaq.sealab.ttep.rew.wizard.normalize.checking.CheckRange(
