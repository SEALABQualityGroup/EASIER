...
public class ValParser implements ValParserConstants {
  ...
  final public it.disim.univaq.sealab.ttep.val.classes.MeasureValue MeasureValue() throws ParseException {
        Token t1;
  ...
  final public it.disim.univaq.sealab.ttep.val.classes.ValSpec ValSpec() throws ParseException {
