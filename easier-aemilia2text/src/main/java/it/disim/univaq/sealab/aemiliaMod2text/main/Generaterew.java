...
/**
 * Entry point of the 'Generaterew' generation module.
 *
 * @generated
 */
public class Generaterew extends AbstractAcceleoGenerator {
	
	public static Logger logger_ = Logger.getLogger(Generaterew.class.getName());
	 ...
	 * @generated
	 */
	public static final String MODULE_FILE_NAME = "/it/disim/univaq/sealab/aemiliaMod2text/main/generaterew";
	 ...
	 * @generated
	 */
	public static final String[] TEMPLATE_NAMES = { "generaterew" };
	 ...
	 * @generated
	 */
	public Generaterew(URI modelURI, File targetFolder, List<? extends Object> arguments) throws IOException {
	 ...
	 * @generated
	 */
	public Generaterew(EObject model, File targetFolder, List<? extends Object> arguments) throws IOException {
		logger_.info(module.getNsURI());
