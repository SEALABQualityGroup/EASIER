...
//		resourceSet = new ResourceSetImpl();
	...
	/*
	 * public Resource getResource() { if (resource == null) { resource =
...
//	}
	...
	/*
	 * public void unloadModelResource() { if (getResource() != null) { // unload
	 * previous resources if existing // unload every resource in the resourceSet
	 * including profiles for (Iterator<Resource> i =
	 * getResourceSet().getResources().iterator(); i.hasNext();) { Resource current
	 * = (Resource) i.next(); current.unload(); i.remove(); } //
	 * EasierLogger.logger_.info("unload Resources"); } }
	 */

	/*
	 * public void unloadModelResource(RSolution solution) { for (Iterator<Resource>
	 * i = solution.getResources().iterator(); i.hasNext();) { Resource current =
	 * (Resource) i.next(); current.unload(); i.remove(); } //
	 * EasierLogger.logger_.info("unload Resources"); }
	 */

	/*
	 * public boolean saveModel() { try { getResource().save(null); return true; }
	 * catch (IOException e) { System.err.println("Error in saving the model " +
	 * getResource().toString()); e.printStackTrace(); return false; } }
	 */

	/*
	 * public boolean saveModel(Resource modelToSave) { try {
	 * modelToSave.save(null); return true; } catch (IOException e) {
	 ...
	 */
	/*
	 * public void save(String destionationPath) { Resource res =
	 * getResourceSet().createResource(URI.createFileURI(destionationPath));
	 * res.getContents().add(EcoreUtil.copy(this.getModel())); try { res.save(null);
	 * } catch (IOException e) {
	...
	/*
	 * public void save(RSolution solution) { try { // if
	 * (solution.getResources().isEmpty()) { //
	...
	/*
	 * public void save(String destionationPath, RSolution solution) { try {
	 * solution.getResources().get(0).save(null); } catch (IOException ioe) {
	 * System.err.println(ioe.getMessage()); } }
	 */

	/*
	 * public ResourceSet getResourceSet() { if (resourceSet == null) resourceSet =
	 * new ResourceSetImpl(); return resourceSet; }
	 * 
	 * public void setResourceSet(ResourceSet set) { this.resourceSet = set; }
	 */
