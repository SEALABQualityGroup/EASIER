...
public class OclAemiliaStringManager extends OclStringManager {
	...
	// PAKIMOR _FIXME NOT OK - ATTUALMENTE ARRIVA AL CommunicationPath del PRIMO
	// NODO
	// DOVE E'
...
//	public String getAllInUniOutOrAttachesQuery(String name) {
//		String query;
//		query = "Attachment.allInstances()->asSequence()->select(a:Attachment|a.end.toInstance.oclAsType(ArchiElemInstance).instanceName.startsWith('" + name + "') "
//															   + "and a.end.isInput.type=InteractionType::UNI "
//															   + "and a.start.isOutput.type=InteractionType::OR)";
//		return query;
//	}
//	
//	
//	public String getAllOutUniInOrAttachesQuery(String name) {
//		String query;
//		query = "Attachment.allInstances()->asSequence()->select(a:Attachment|a.start.fromInstance.oclAsType(ArchiElemInstance).instanceName.startsWith('" + name + "') " 
//															   + "and a.start.isOutput.type=InteractionType::UNI "
//															   + "and a.end.isInput.type=InteractionType::OR)";
//		return query;
//	}
